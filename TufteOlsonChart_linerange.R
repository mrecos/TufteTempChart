...
# build plot using geom_linerange
ggplot() +
  geom_linerange(data = dat, aes(x = day, ymin = record_min_temp,
                                 ymax = record_max_temp), color='#C3BBA4', size = 1.5)  +
  geom_linerange(data = dat, aes(x = day, ymin = average_min_temp,
                                 ymax = average_max_temp), color='#9A9180', size = 2)  +
  geom_linerange(data = dat, aes(x = day, ymin = actual_min_temp,
                                 ymax = actual_max_temp), size = 0.75, color='#5A3B49') +
